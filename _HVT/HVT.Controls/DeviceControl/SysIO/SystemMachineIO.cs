...
namespace HVT.Controls
{
    public class SystemMachineIO : INotifyPropertyChanged
    {
        ...
        public event EventHandler OnSubStartRequest;
        ...
        public bool SubStart
        {
            ...
            set
            {
                if (value != _subStart)
                {
                    ...
                    if (value == true)
                    {
                        OnSubStartRequest?.Invoke(_subStart, null);
                    }
                }
            }
        }
